                ...
                <!-- form start -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="file"  class="form-control-file" accept="image/*" @change="addImage">
                                <br>
...
export default {
    props: ['edit_product','edit_stocks','product_image'],
    components: {
       ShowError
    },
    data(){
    ...
    mounted(){
        ...
        //Set old data
        this.form.category_id = this.edit_product.category_id
        this.form.brand_id = this.edit_product.brand_id
        this.form.sku = this.edit_product.sku
        this.form.product_name = this.edit_product.product_name
        this.form.image = this.edit_product.image
        this.form.cost_price = this.edit_product.cost_price
        this.form.retail_price = this.edit_product.retail_price
        this.form.year = this.edit_product.year
        this.form.description = this.edit_product.description
        this.form.status = this.edit_product.status
        this.form.items = this.edit_stocks
    },
