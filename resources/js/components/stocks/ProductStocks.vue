        ...
        <div class="col-sm-6">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Product Stocks Form</h3>
                ...
                <!-- form start -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                           ...
                           <div class="form-group row">
                            <label for="sku" class="col-sm-3 col-form-label">Stock Type <span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                 <select   class="form-control" v-model="form.status" >
                                    <option value="in">Stocks In</option>
                                    <option value="out">Stocks Out</option>
                                </select>
                            </div>
                        </div>
